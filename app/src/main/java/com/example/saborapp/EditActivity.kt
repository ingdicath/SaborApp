    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        myRef.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                if (recipe != null) {
                    nameEditText.text = Editable.Factory.getInstance().newEditable(recipe.name)
                    dateEditText.text = Editable.Factory.getInstance().newEditable(recipe.date)
                    descriptionEditText.text = Editable.Factory.getInstance().newEditable(recipe.description)
                    urlEditText.text = Editable.Factory.getInstance().newEditable(recipe.url)
                }
